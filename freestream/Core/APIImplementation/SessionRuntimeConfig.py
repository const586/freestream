...
class SessionRuntimeConfig(SessionConfigInterface):
    ...
    def set_value(self, name, value):
        ...
        try:
            return SessionConfigInterface.set_value(self, name, value)
        finally:
    ...
    def get_value(self, name, default = None):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_value(self, name, default)
        finally:
            self.sesslock.release()
    ...
    def get_ads_dir(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_ads_dir(self)
        finally:
            self.sesslock.release()
